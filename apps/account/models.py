...
class User(models.Model):
    ...
    sex = models.CharField(max_length=11,choices=(('male','男'),('female','女'),('secret','保密')),null=True,verbose_name='性别')
    birthday = models.DateField(max_length=255,verbose_name='生日',default='1970-10-10')
    nickname = models.CharField(max_length=64, unique=True, verbose_name="用户昵称",null=True)
